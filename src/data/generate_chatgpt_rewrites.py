...
DEFAULT_INPUT_PATH = PROJECT_ROOT / "data" / "processed" / "rewrite_prompts_chatgpt.jsonl"
DEFAULT_OUTPUT_PATH = PROJECT_ROOT / "data" / "processed" / "llm_rewrite_chatgpt.jsonl"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate ChatGPT rewrites via GPTSAPI.")
...
def main():
    ...
    print("=" * 70)
    print("ChatGPT Rewrite Generation via GPTSAPI")
    print("=" * 70)
